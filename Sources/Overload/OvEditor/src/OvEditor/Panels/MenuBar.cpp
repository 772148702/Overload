...
void OvEditor::Panels::MenuBar::CreateHelpMenu()
{
    ...
    helpMenu.CreateWidget<MenuItem>("Getting Started").ClickedEvent += [] {OvTools::Utils::SystemCalls::OpenURL("https://github.com/adriengivry/Overload/wiki/Getting-Started"); };
